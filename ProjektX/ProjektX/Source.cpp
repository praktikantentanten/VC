...
int main(int argc, char *argv[])
{
		...
		for (i = 0; i <3;i++)
		{
			Speicher.Save(Proj.bildRotieren(image, winkels.at<double>(i, 0)+90, winkels.at<double>(i, 1)+90,90), image, "3Winkel", Mathe.WinkelZuString(winkels.at<double>(i, 0), winkels.at<double>(i, 1),90));
